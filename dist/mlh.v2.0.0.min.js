...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_lib_js_cookie_2_2_0_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/lib/js.cookie-2.2.0.min */ \"./node_modules/mlh-javascript/js/lib/js.cookie-2.2.0.min.js\");\n/* harmony import */ var _js_lib_js_cookie_2_2_0_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_js_lib_js_cookie_2_2_0_min__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var script_loader_js_lib_cryptojs_md5_3_1_2_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! script-loader!./js/lib/cryptojs.md5-3.1.2.min */ \"./node_modules/script-loader/index.js!./node_modules/mlh-javascript/js/lib/cryptojs.md5-3.1.2.min.js\");\n/* harmony import */ var script_loader_js_lib_cryptojs_md5_3_1_2_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(script_loader_js_lib_cryptojs_md5_3_1_2_min__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nfunction parseURLHash() {\n  const hash = {};\n\n  if (window.location.hash && window.location.hash.length > 0) {\n    const params = window.location.hash.substr(1).split('&');\n    let param;\n\n    for (let i = 0; i < params.length; i += 1) {\n      param = params[i].split('=');\n      // eslint-disable-next-line\n      hash[param[0]] = param[1];\n    }\n\n    if (window.history.pushState) {\n      window.history.pushState('', '/', window.location.pathname);\n    } else {\n      window.location.hash = '';\n    }\n  }\n\n  return hash;\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  login: function(cb) {\n    const hash = parseURLHash();\n    const currentUser = _js_lib_js_cookie_2_2_0_min__WEBPACK_IMPORTED_MODULE_0___default.a.getJSON('mymlh');\n\n    if (currentUser) {\n      cb(currentUser);\n    } else if (hash && hash.access_token) {\n        const url = `https://my.mlh.io/api/v2/user.json?access_token=${hash.access_token}`;\n        return $.getJSON(url).done((res) => {\n          res.data.gravatar = `https://www.gravatar.com/avatar/${CryptoJS.MD5(res.data.email)}?d=retro`;\n          _js_lib_js_cookie_2_2_0_min__WEBPACK_IMPORTED_MODULE_0___default.a.set('mymlh', res.data);\n          cb(res.data);\n        }).fail(console.log);\n    }\n  },\n  logout: function(cb) {\n    _js_lib_js_cookie_2_2_0_min__WEBPACK_IMPORTED_MODULE_0___default.a.remove('mymlh');\n    cb()\n  },\n  signUpForNewsLetter: function() {\n\n  }\n});\n\n//# sourceURL=webpack:///./node_modules/mlh-javascript/index.js?");
